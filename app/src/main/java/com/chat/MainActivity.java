...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApi.API_KEY = mApi.sharedPreferences.getString("key", "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");
        ...
        mApi.use_vps = mApi.sharedPreferences.getString("use_vps", "不使用中转");
        ...
        mApi.vits_speaker = mApi.sharedPreferences.getString("vits_model", "可莉");
